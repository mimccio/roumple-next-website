...
export async function Footer({ lang }: Props) {
  ...
  return (
    <div className="via-insigo-200 flex w-full flex-col items-center bg-gradient-to-b from-indigo-100 from-10% via-30% to-indigo-300 to-80% px-12 lg:px-20">
      ...
      <div className="grid w-full max-w-3xl grid-cols-1 items-end justify-between gap-y-8 py-20 lg:grid-cols-2">
        <div className="flex text-sm flex-col gap-4 pt-16">
